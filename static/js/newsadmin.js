$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(value, index, array) {
                    ...
                    var $tdimg = $("<td>").html("<img src=/upload/"+value.newsimg+" width='40' height='30'>" );
    ...
    $("#submitbtn").click(function(e) {
        ...
        if ($("#newstitle").val() == "" || !isNaN($("#newstitle").val()) || $("#newstime").val() == "" || $("#newsing").val() == "") {
            ...
            formData.append('newstype',$("#newstype").val());
...
$("#confirmupdate").click(function() {
        ...
        var formData = new FormData();
        formData.append('file',file[0].files[0]);
        formData.append('newsid',$updateId);
        formData.append('newstitle',$("#unewstitle").val());
        formData.append('newstime',$("#unewstime").val());
        formData.append('newstype',$("#unewstype").val());


        $.ajax({
            url: '/admin/news/updelete',
            type: 'post',
            datatype: 'json',
            data: formData,
            cache: false,
